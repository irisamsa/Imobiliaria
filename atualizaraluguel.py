...
def atualizarAluguel(nomelocador, nomelocatario, fiadorI, ecI, profI, rgI, cpfI, ruaI, numI, bairroI, cidadeI, ufI, conjugueI, rgconjugueI, cpfconjugueI, fiadorII, ecII, profII, rgII, cpfII, ruaII, numII, bairroII, cidadeII, ufII, conjugueII, rgconjugueII, cpfconjugueII ,registro,prazo, inicio, fim, valor, vencimento):
    pdf=FPDF()
    pdf=FPDF('P','mm','A4')
